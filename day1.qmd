...
* use your terminal program (not your webbrowser)
...
and so the email address used should be the same as the one 
you (will) use with your GitHub account.
If you already have a GitHub account, choose one from the [page listing your like on github.com](https://github.com/settings/emails)
...
~~~
  ssh-ed25519 AAAAC3NzaC1lZDI1NT... your@email.address
~~~
